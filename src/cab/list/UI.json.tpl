{
    ...
    "_grid": {
        ...
        "options": {
            ...
            "search.advanced.title": "搜索#MODULE#",
            ...
            "ajax.search.uri": "/api/#API#/search",
            "ajax.get.uri": "/api/#API#/:key",
            "ajax.delete.uri": "/api/#API#/:key",
            "ajax.batch.delete.uri": "/api/batch/#API#/delete",
            "ajax.batch.update.uri": "/api/batch/#API#/update",
            "ajax.column.full": "/api/columns/#API#/full",
            "ajax.column.my": "/api/columns/#API#/my",
            "ajax.column.save": "/api/columns/#API#/my",
            "ajax.file.export": "/api/#API#/export",
            "ajax.file.import": "/api/#API#/import",
            "confirm.delete": "确认删除当前#MODULE#记录？",
            "confirm.batch.delete": "您确认要删除所有选中的#MODULE#记录？",
